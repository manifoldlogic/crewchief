...
const Worktrees: React.FC = () => {
  const [worktrees] = useState<Worktree[]>([
    {
      id: '1',
      name: 'agent-123-feature-auth',
      status: 'active',
      branch: 'feature/authentication',
      agent: 'claude-code',
      lastActivity: '2 minutes ago',
      path: '.crewchief/worktrees/agent-123-feature-auth'
    },
    {
      id: '2',
      name: 'agent-456-bugfix-routing',
      status: 'idle',
      branch: 'bugfix/routing-issues',
      agent: 'cursor-gpt',
      lastActivity: '1 hour ago',
      path: '.crewchief/worktrees/agent-456-bugfix-routing'
    },
    {
      id: '3',
      name: 'agent-789-refactor-db',
      status: 'error',
      branch: 'refactor/database-layer',
      agent: 'copilot',
      lastActivity: '3 hours ago',
      path: '.crewchief/worktrees/agent-789-refactor-db'
    },
  ]);
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                Isolated git worktrees for agent development
              </p>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900 dark:text-white">
                    {worktrees.filter(w => w.status === 'idle').length}
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900 dark:text-white">
                    {worktrees.filter(w => w.status === 'error').length}
                  </dd>
                </dl>
              </div>
            </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center mb-2">
                      ...
                      <span className={`ml-3 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(worktree.status)}`}>
                        {getStatusIcon(worktree.status)}
                        <span className="ml-1 capitalize">{worktree.status}</span>
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-gray-600 dark:text-gray-300">
                      ...
                      <div className="flex items-center">
                        ...
                        Last activity: {worktree.lastActivity}
                      </div>
                    </div>
