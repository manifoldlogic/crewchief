-- Migration 002: Create code_embeddings table and migrate deduplicated embeddings
-- Purpose: Separate embeddings into content-addressed storage for massive deduplication
-- Related: BLOBSHA-2001
-- Depends on: 001_add_blob_sha.sql (chunks must have blob_sha populated)
...
-- ============================================================================
-- Next steps:
--   1. Update application queries to JOIN chunks with code_embeddings (BLOBSHA-2002)
--   2. Remove embedding column from chunks table (BLOBSHA-2003)
--   3. Update Rust indexer to insert into code_embeddings (BLOBSHA-2004)
--
-- Performance notes:
...
--   Note: Original embeddings still in chunks.embedding column until migration 003
