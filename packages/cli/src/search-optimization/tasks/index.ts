...
} from './ambiguity-resolution/index.js'
import {
...
} from './conceptual-similarity/index.js'
import { TASK_FIND_CLI_ENTRY, TASK_FIND_SDK_CONFIG } from './config.js'
import { TASK_ASYNC_ERROR_HANDLING, TASK_SECURITY_LOGGING, TASK_INPUT_VALIDATION } from './cross-cutting/index.js'
...
import {
  ...
  TASK_API_IMPACT_ANALYSIS as TASK_API_IMPACT_ANALYSIS_REALWORLD,
} from './realworld/index.js'
...
export const ALL_TASKS: SearchTask[] = [
  ...
  // Type 9: Conceptual Similarity (4 tasks - medium/grep-hard)
  TASK_RETRY_IMPLEMENTATIONS,
  TASK_ERROR_HANDLING_PATTERNS,
  TASK_RATE_LIMITING,
  TASK_CACHING_STRATEGIES,

  // Type 10: Ambiguity Resolution (4 tasks - medium/grep-hard)
  TASK_TRANSACTION_MANAGEMENT,
  TASK_AUTHENTICATION_CHECKS,
  TASK_RESOURCE_CLEANUP,
  TASK_CACHE_OPERATIONS,

  // Type 11: Cross-Cutting Concerns (3 tasks - medium/grep-hard)
  TASK_ASYNC_ERROR_HANDLING,
  TASK_SECURITY_LOGGING,
  TASK_INPUT_VALIDATION,

  // Type 12: Real-World Tasks - Tier 3 (9 tasks - easy/medium/real-world)
  // Code Review (3)
  TASK_AUTH_PERMISSION_CHECK,
  TASK_DATABASE_MIGRATION_SAFETY,
  TASK_ERROR_HANDLING_CONSISTENCY,
  ...
  TASK_DEPRECATE_FUNCTION,
  TASK_EXTRACT_PATTERN,
  TASK_API_IMPACT_ANALYSIS_REALWORLD,
]
