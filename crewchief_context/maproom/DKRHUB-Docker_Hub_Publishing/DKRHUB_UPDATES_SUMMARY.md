...
1. `.agents/work-tickets/DKRHUB-1001_create-github-actions-workflow.md`
2. `.agents/work-tickets/DKRHUB-1002_configure-multi-platform-build.md`
3. `.agents/work-tickets/DKRHUB-1003_implement-docker-hub-authentication.md`
4. `.agents/work-tickets/DKRHUB-1004_implement-version-extraction-tagging.md`
5. `.agents/work-tickets/DKRHUB-1005_configure-image-build-push.md`
6. `.agents/work-tickets/DKRHUB-1006_add-security-scanning-trivy.md`
7. `.agents/work-tickets/DKRHUB-1901_test-workflow-pre-release.md`
8. `.github/workflows/publish-maproom-mcp-image.yml`

### Created (5 files)
1. `.agents/work-tickets/DKRHUB-1000_create-combined-dockerfile.md`
2. `.agents/work-tickets/DKRHUB-1007_test-dockerfile-locally.md`
3. `.agents/work-tickets/DKRHUB-2004_create-test-docker-compose.md`
4. `.agents/work-tickets/DKRHUB-2904_validate-prerelease-images.md`
5. `.agents/work-tickets/DKRHUB-3006_create-rollback-procedure.md`
