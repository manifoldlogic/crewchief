...
grep -r "embedding" .crewchief/archive/projects/MPEMBED_multi-provider-embeddings/tickets/

# Review architecture decisions
cat .crewchief/archive/projects/HYBRID_SEARCH_hybrid-retrieval-system/planning/architecture.md
```
