...
This document provides a **critical path analysis** and **proposed completion order** for all active projects in `.crewchief/projects/`. After thorough analysis of every ticket, git history, and project dependencies, here's what needs to happen:
...
```bash
# Archive project
mv .crewchief/projects/MAPROOM_MIGRATIONS_migration-fixes .crewchief/archive/projects/
git add .crewchief/
...
Follow: `.crewchief/projects/BINPKG_binary-packaging/MANUAL_EXECUTION_GUIDE.md`
