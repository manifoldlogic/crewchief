...
The security review (`.crewchief/projects/DAEMIGR_daemon-client-migration/planning/security-review.md`) has identified key security considerations that need to be communicated to users. This ticket translates those technical findings into actionable documentation in the README.
...
- **Reference**: `/workspace/.crewchief/projects/DAEMIGR_daemon-client-migration/planning/security-review.md`
