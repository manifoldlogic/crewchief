...
**Reference architecture**: `.crewchief/projects/DAEMIGR_daemon-client-migration/planning/architecture.md` (lines 404-465)
...
**Planning reference**:
- `.crewchief/projects/DAEMIGR_daemon-client-migration/planning/architecture.md` (lines 404-465)
