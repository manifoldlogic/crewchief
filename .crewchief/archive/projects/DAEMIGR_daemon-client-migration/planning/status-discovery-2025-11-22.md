...
1. **Read all DAEMIGR ticket files** in `.crewchief/projects/DAEMIGR_daemon-client-migration/tickets/`
...
1. **`.crewchief/projects/DAEMIGR_daemon-client-migration/tickets/DAEMIGR_TICKET_INDEX.md`**
...
2. **`.crewchief/projects/DAEMIGR_daemon-client-migration/README.md`**
...
3. **`.crewchief/projects/DAEMIGR_daemon-client-migration/planning/status-discovery-2025-11-22.md`** (this file)
...
- [ ] Update `.crewchief/archive/README.md` if project is archived
