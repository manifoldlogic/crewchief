...
Reference: `.crewchief/projects/CIFIX_ci-workflow-fixes/planning/architecture.md` Section "Precise Dockerfile Implementation" (lines 131-220)
...
## Planning References
- `.crewchief/projects/CIFIX_ci-workflow-fixes/planning/architecture.md` (lines 131-220) - "Precise Dockerfile Implementation"
- `.crewchief/projects/CIFIX_ci-workflow-fixes/planning/architecture.md` (lines 99-127) - "Proposed Architecture"
