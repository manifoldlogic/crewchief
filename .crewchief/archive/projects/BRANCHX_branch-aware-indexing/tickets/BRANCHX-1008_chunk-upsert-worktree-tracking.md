...
Reference: `.crewchief/projects/BRANCHX_branch-aware-indexing/planning/plan.md` - Phase 3.2 (Upsert Chunks with Worktree Tracking)
...
## Planning References
- `.crewchief/projects/BRANCHX_branch-aware-indexing/planning/plan.md` - Phase 3.2 (lines 171-213)
- `.crewchief/projects/BRANCHX_branch-aware-indexing/planning/architecture.md` - Upsert Chunk with Worktree Tracking (lines 210-256)
