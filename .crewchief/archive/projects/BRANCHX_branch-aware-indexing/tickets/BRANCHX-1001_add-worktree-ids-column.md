...
Reference: `.crewchief/projects/BRANCHX_branch-aware-indexing/planning/plan.md` - Phase 1, Step 1.1
...
See `.crewchief/projects/BRANCHX_branch-aware-indexing/planning/architecture.md` section "Database Schema Design" for full design rationale and query patterns.
...
## Planning References
- `.crewchief/projects/BRANCHX_branch-aware-indexing/planning/plan.md` - Phase 1, Step 1.1
- `.crewchief/projects/BRANCHX_branch-aware-indexing/planning/architecture.md` - Database Schema Design section
