...
The SQLVEC project (`.crewchief/projects/SQLVEC_sqlite-vec-backend/`) started implementing an SQLite backend for Maproom but was left in an incomplete state with multiple compile-time and runtime issues.
