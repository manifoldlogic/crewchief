...
The TESTDES project has created a comprehensive framework for designing and validating grep-impossible tasks. This knowledge currently resides in `.crewchief/projects/TESTDES_grep-impossible-task-design/`. To make it accessible and preserve it long-term, we need to:
...
This follows the CrewChief workflow: active work in `.crewchief/`, finalized knowledge in `docs/`, completed projects in `.crewchief/archive/`.
...
- [x] Project archived to `.crewchief/archive/projects/TESTDES_grep-impossible-task-design/`
...
1. Move entire directory:
   ```bash
   mv .crewchief/projects/TESTDES_grep-impossible-task-design/ \
      .crewchief/archive/projects/TESTDES_grep-impossible-task-design/
   ```

2. Create archive README:
   ```
   .crewchief/archive/projects/TESTDES_grep-impossible-task-design/ARCHIVE_README.md
   ```
...
Create: `.crewchief/archive/projects/TESTDES_grep-impossible-task-design/HANDOFF.md`
...
5. Update `.crewchief/archive/README.md` to list TESTDES project
...
**New Files**:
- `.crewchief/archive/projects/TESTDES_grep-impossible-task-design/ARCHIVE_README.md`
- `.crewchief/archive/projects/TESTDES_grep-impossible-task-design/HANDOFF.md`

**Updated Files**:
- `docs/architecture/SEARCH_EVALUATION.md` - Add grep-impossible framework section
- `README.md` - Add framework to features list
- `.crewchief/archive/README.md` - Add TESTDES to archive index (if archive README exists)
...
- `/workspace/.crewchief/projects/TESTDES_grep-impossible-task-design/` - Directory to archive

**Planning References**:
- `.crewchief/projects/TESTDES_grep-impossible-task-design/planning/plan.md:346-362` - Phase 6.3 requirements
- `.crewchief/projects/TESTDES_grep-impossible-task-design/planning/quality-strategy.md:498-508` - Knowledge preservation strategy
- `.crewchief/README.md` - Agent workspace conventions
