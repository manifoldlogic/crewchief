...
- `.crewchief/projects/SCHMAFIX_schema-migration-integration/planning/plan.md` (Phase 4)
- `.crewchief/projects/SCHMAFIX_schema-migration-integration/planning/analysis.md` (Original problem: code_embeddings table missing)
- `.crewchief/projects/SCHMAFIX_schema-migration-integration/planning/quality-strategy.md` (MCP integration validation)
