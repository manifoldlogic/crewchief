...
- **Research**: `.crewchief/research/ai-agent-query-optimization.md` (comprehensive analysis)
- **Natural Language Query Optimization**: `.crewchief/research/natural-language-query-optimization.md` (server-side approaches)
- **Branch-Aware Indexing**: `.crewchief/research/branch-aware-indexing-architecture.md` (future enhancement)
