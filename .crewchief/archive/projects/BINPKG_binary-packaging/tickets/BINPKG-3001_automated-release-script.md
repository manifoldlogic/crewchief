...
- **Planning doc**: `.crewchief/projects/BINPKG_binary-packaging/planning/plan.md` (Phase 3, Release automation)
...
### Planning Documents
- **Project plan**: `.crewchief/projects/BINPKG_binary-packaging/planning/plan.md` (Phase 3, Release automation)
- **Architecture**: `.crewchief/projects/BINPKG_binary-packaging/planning/architecture.md` (Developer workflow section)
