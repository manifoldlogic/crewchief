...
**Planning reference**: `.crewchief/projects/BINPKG_binary-packaging/planning/plan.md` (Phase 1, darwin-arm64 implementation)
...
- `/workspace/.crewchief/work-tickets/BINPKG-1004_macos-x64-binary-build.md` - Reference pattern (nearly identical)
