...
- **Planning doc**: `.crewchief/projects/BINPKG_binary-packaging/planning/plan.md` (Phase 1, lines 11-62)
- **Architecture doc**: `.crewchief/projects/BINPKG_binary-packaging/planning/architecture.md` (lines 139-212)
...
- `/workspace/.crewchief/projects/BINPKG_binary-packaging/planning/architecture.md` - Technical architecture
