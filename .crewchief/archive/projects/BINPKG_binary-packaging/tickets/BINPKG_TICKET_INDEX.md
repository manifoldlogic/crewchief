...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-1001_github-actions-workflow-structure.md`
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-1002_linux-x64-binary-build.md`
- **Agent**: general-purpose
- **Effort**: 2 hours
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-1003_linux-arm64-binary-build.md`
- **Agent**: general-purpose
- **Effort**: 1 hour
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-1004_macos-x64-binary-build.md`
- **Agent**: general-purpose
- **Effort**: 1 hour
- **Dependencies**: BINPKG-1001
- **Status**: Ready
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-1005_macos-arm64-binary-build.md`
- **Agent**: general-purpose
- **Effort**: 1 hour
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-1006_validate-binary-artifacts.md`
- **Agent**: general-purpose
- **Effort**: 2-3 hours
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-1007_npm-publish-with-verification.md`
- **Agent**: general-purpose
- **Effort**: 2 hours
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-1901_canary-release-integration-test.md`
- **Agent**: test-runner
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-2001_local-binary-validation-script.md`
- **Agent**: general-purpose
- **Effort**: 1-2 hours
- **Dependencies**: None
- **Status**: Ready
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-2002_prepublish-hook-package-files.md`
- **Agent**: general-purpose
- **Effort**: 0.5 hours
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-2901_test-local-validation-script.md`
- **Agent**: test-runner
- **Effort**: 1-2 hours
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-3001_automated-release-script.md`
- **Agent**: general-purpose
- **Effort**: 2-3 hours
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-3002_update-release-scripts.md`
- **Agent**: general-purpose
- **Effort**: 0.5 hours
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-4001_document-release-process.md`
- **Agent**: general-purpose
- **Effort**: 2-3 hours
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-5001_dry-run-release-test.md`
- **Agent**: test-runner
- **Effort**: 1-2 hours
...
- **File**: `/workspace/.crewchief/work-tickets/BINPKG-5002_execute-first-production-release.md`
- **Agent**: general-purpose
...
- **Project README**: `/workspace/.crewchief/projects/BINPKG_binary-packaging/README.md`
- **Implementation Plan**: `/workspace/.crewchief/projects/BINPKG_binary-packaging/planning/plan.md`
- **Architecture**: `/workspace/.crewchief/projects/BINPKG_binary-packaging/planning/architecture.md`
- **Quality Strategy**: `/workspace/.crewchief/projects/BINPKG_binary-packaging/planning/quality-strategy.md`
- **Security Review**: `/workspace/.crewchief/projects/BINPKG_binary-packaging/planning/security-review.md`
- **Analysis**: `/workspace/.crewchief/projects/BINPKG_binary-packaging/planning/analysis.md`
