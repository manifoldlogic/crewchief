...
This ticket implements Step 3.2 from `.crewchief/projects/IDXSIZE_index-size-limits/planning/plan.md` (lines 336-371).
...
Follow migration execution procedure from `.crewchief/projects/IDXSIZE_index-size-limits/planning/plan.md` Step 3.2 (lines 336-371).
