...
- [ ] **IDXSIZE-2003: Production Clone Test Documentation**
  - Documentation location: `/workspace/.crewchief/projects/IDXSIZE_index-size-limits/testing/`
  - Files verified:
...
- [ ] **Production Clone Test Executed**
  - Procedure: `/workspace/.crewchief/projects/IDXSIZE_index-size-limits/testing/production-clone-test-procedure.md`
...
- [ ] **Test Results Documented**
  ...
  - Location: `/workspace/.crewchief/projects/IDXSIZE_index-size-limits/testing/migration_test_results_[DATE].txt`
...
**NOTE**: If production clone test has not been executed, DO NOT PROCEED. Execute the test following the procedure in `/workspace/.crewchief/projects/IDXSIZE_index-size-limits/testing/production-clone-test-procedure.md` before continuing.
...
1. **Review migration execution guide**: `/workspace/.crewchief/projects/IDXSIZE_index-size-limits/deployment/migration-execution-guide.md`
...
- **Test Documentation**: `/workspace/.crewchief/projects/IDXSIZE_index-size-limits/testing/`
- **Migration Guide**: `/workspace/.crewchief/projects/IDXSIZE_index-size-limits/deployment/migration-execution-guide.md`
