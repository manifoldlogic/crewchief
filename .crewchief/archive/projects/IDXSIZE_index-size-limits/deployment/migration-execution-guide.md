...
- [ ] Migration log updated in `.crewchief/projects/IDXSIZE_index-size-limits/`
...
- `/workspace/.crewchief/projects/IDXSIZE_index-size-limits/testing/production-clone-test-procedure.md`
