...
References:
- Architecture: `.crewchief/projects/MRPROG_maproom-progress-ux/planning/architecture.md` (CLI Argument Parsing section)
- Plan: `.crewchief/projects/MRPROG_maproom-progress-ux/planning/plan.md` (Phase 2, task 2)
