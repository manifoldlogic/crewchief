...
- Quality strategy: `.crewchief/projects/MRPROG_maproom-progress-ux/planning/quality-strategy.md` (Integration Tests section)
- Project plan: `.crewchief/projects/MRPROG_maproom-progress-ux/planning/plan.md` (Phase 2, Task 3)
