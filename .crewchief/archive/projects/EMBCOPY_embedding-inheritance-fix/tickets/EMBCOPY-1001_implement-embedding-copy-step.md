...
**Planning References:**
- Architecture: `.crewchief/projects/EMBCOPY_embedding-inheritance-fix/planning/architecture.md` (lines 15-85)
- Plan: `.crewchief/projects/EMBCOPY_embedding-inheritance-fix/planning/plan.md` (lines 11-49)
