...
This document defines the test strategy, scope, cases, and execution approach for CrewChief as specified in `docs/specification.md` and implemented per `docs/technology.md` and `docs/project-plan.md`.
