...
Project directory: `.agents/projects/[PROJECT_SLUG]-*/`
Plan: `.agents/projects/[PROJECT_SLUG]-*/planning/plan.md`
Architecture: `.agents/projects/[PROJECT_SLUG]-*/planning/architecture.md`
Tickets: `.agents/projects/[PROJECT_SLUG]-*/tickets/`
Output: `.agents/projects/[PROJECT_SLUG]-*/planning/tickets-review-report.md`

# Task

Conduct thorough review of all tickets for project "[PROJECT_SLUG]" to ensure quality, feasibility, and integration before execution begins.
...
Create comprehensive report in `.agents/projects/[PROJECT_SLUG]-*/planning/tickets-review-report.md`:
