...
Plan: .agents/projects/[PROJECT_SLUG]-*/planning/[PROJECT_SLUG]_PLAN.md
Output: .agents/projects/[PROJECT_SLUG]-*/tickets/[PROJECT_SLUG]-*

# Task

Use the ticket-creator agent to systematically create all tickets for project "[PROJECT_SLUG]" based on the project plan and supporting documents.

## Preparation

1. Review .agent/reference/ticket-creator.md (if available) and .agent/reference/work-ticket-template.md (if available)
...
- Phase 1 = 1xxx (e.g., [PROJECT_SLUG]-1001_initial-setup.md)
- Phase 2 = 2xxx (e.g., [PROJECT_SLUG]-2003_implement-core.md)
- Test tickets = x9xx (e.g., [PROJECT_SLUG]-1901_test-critical-path.md)
...
Create ticket index: `.agents/projects/[PROJECT_SLUG]-*/tickets/[PROJECT_SLUG]_TICKET_INDEX.md`
