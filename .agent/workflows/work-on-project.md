...
Execute all tickets for project "[PROJECT_SLUG]" systematically using autonomous workflow until project completion.
...
2. **Load ticket inventory:**
   - Read ticket index: `[PROJECT_SLUG]_TICKET_INDEX.md`
...
**Execution rhythm:**
```
1. Execute: single-ticket workflow for <ticket-id>
