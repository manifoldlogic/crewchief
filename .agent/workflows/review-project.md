...
Tickets (if created): `.agents/projects/[PROJECT_SLUG]-*/tickets/`
Output: `.agents/projects/[PROJECT_SLUG]-*/planning/project-review.md`

# Task

Conduct a comprehensive critical review of project "[PROJECT_SLUG]" to identify gaps, risks, and execution concerns. This review should be run BEFORE creating tickets to catch issues early, but can also be run after ticket creation for a more complete assessment.
...
Create comprehensive review in `.agents/projects/[PROJECT_SLUG]-*/planning/project-review.md`:
