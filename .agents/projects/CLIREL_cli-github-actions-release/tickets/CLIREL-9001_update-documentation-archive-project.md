...
```bash
mv /workspace/.agents/projects/CLIREL_cli-github-actions-release \
   /workspace/.agents/archive/projects/CLIREL_cli-github-actions-release
```

**Create archive README**:

**File**: `/workspace/.agents/archive/projects/CLIREL_cli-github-actions-release/ARCHIVE_README.md`
...
- `/workspace/.agents/archive/projects/CLIREL_*/ARCHIVE_README.md` (create)
- `/workspace/.agents/projects/CLIREL_*` (move to archive)
