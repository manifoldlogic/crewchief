...
## Background
Agents and users need to know what projects exist in the workspace. This command scans the `.agents/projects/` directory and outputs a formatted list.

Reference: planning/plan.md - Phase 2: Management, Step 4 (List Command)

## Acceptance Criteria
- [ ] Scans `.agents/projects/` directory for project folders
