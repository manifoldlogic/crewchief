...
Reference: `.agents/projects/MRPROG_maproom-progress-ux/planning/plan.md` (Completion Checklist section)
...
Create: `.agents/projects/MRPROG_maproom-progress-ux/COMPLETION_REPORT.md`
...
4. Merge to main
5. Archive project to `.agents/archive/projects/`
...
### Files to Create
- `.agents/projects/MRPROG_maproom-progress-ux/COMPLETION_REPORT.md` (final report)
