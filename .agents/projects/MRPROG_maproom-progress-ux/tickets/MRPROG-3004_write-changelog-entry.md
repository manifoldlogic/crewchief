...
**Content Sources:**
- Project README: `.agents/projects/MRPROG_maproom-progress-ux/README.md` (Example Output)
- Plan: `.agents/projects/MRPROG_maproom-progress-ux/planning/plan.md` (Phase 3, task 6)
- Analysis: `.agents/projects/MRPROG_maproom-progress-ux/planning/analysis.md` (User stories)
