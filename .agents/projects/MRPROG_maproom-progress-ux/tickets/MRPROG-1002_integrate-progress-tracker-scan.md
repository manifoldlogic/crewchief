...
See `.agents/projects/MRPROG_maproom-progress-ux/planning/architecture.md` section "Changes to scan_worktree()" for detailed design rationale.
...
## References
- Architecture doc: `.agents/projects/MRPROG_maproom-progress-ux/planning/architecture.md` (section "Changes to scan_worktree()")
- Current implementation: `crates/maproom/src/indexer/mod.rs` lines 286-435
- Project plan: `.agents/projects/MRPROG_maproom-progress-ux/planning/plan.md`
