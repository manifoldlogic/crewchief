...
**Reference**: `.agents/projects/MRPROG_maproom-progress-ux/planning/quality-strategy.md` (Unit Tests section)
...
## References
- Quality strategy: `.agents/projects/MRPROG_maproom-progress-ux/planning/quality-strategy.md` (Unit Tests section)
- Architecture: `.agents/projects/MRPROG_maproom-progress-ux/planning/architecture.md`
- Phase 1 Plan: `.agents/projects/MRPROG_maproom-progress-ux/planning/plan.md` (Testing section)
