...
- **Analysis:** `.agents/projects/DINDFX_docker-workspace-path-detection/planning/analysis.md`
- **Architecture:** `.agents/projects/DINDFX_docker-workspace-path-detection/planning/architecture.md`
- **Plan:** `.agents/projects/DINDFX_docker-workspace-path-detection/planning/plan.md`
- **Quality Strategy:** `.agents/projects/DINDFX_docker-workspace-path-detection/planning/quality-strategy.md`
- **Security Review:** `.agents/projects/DINDFX_docker-workspace-path-detection/planning/security-review.md`
- **Review Updates:** `.agents/projects/DINDFX_docker-workspace-path-detection/planning/review-updates.md`
