...
**Planning Reference:** `.agents/projects/IDXCLEAN_index-stale-worktree-cleanup/planning/plan.md` - Phase 2: CLI Command Interface, ticket IDXCLEAN-2004 (lines 336-389)
