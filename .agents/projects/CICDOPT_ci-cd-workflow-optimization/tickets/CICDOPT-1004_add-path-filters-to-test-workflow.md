...
- [ ] `.agents/**` excluded (planning/tickets)
...
3. `.agents/**` → Project planning/tickets
...
- `.agents/projects/CICDOPT_ci-cd-workflow-optimization/planning/review-updates.md` (path filter requirements)
