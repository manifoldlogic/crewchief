...
- `.agents/projects/MCPINIT_mcp-extension-initialization/planning/version-strategy.md` - Version pinning strategy
- `.agents/projects/MCPINIT_mcp-extension-initialization/planning/security-review.md` - Security requirements
