...
- **Project Plan:** `.agents/projects/NPMDEP_npm-deprecation/planning/plan.md`
- **Architecture:** `.agents/projects/NPMDEP_npm-deprecation/planning/architecture.md`
- **Quality Strategy:** `.agents/projects/NPMDEP_npm-deprecation/planning/quality-strategy.md`
- **Security Review:** `.agents/projects/NPMDEP_npm-deprecation/planning/security-review.md`
- **Project README:** `.agents/projects/NPMDEP_npm-deprecation/README.md`
