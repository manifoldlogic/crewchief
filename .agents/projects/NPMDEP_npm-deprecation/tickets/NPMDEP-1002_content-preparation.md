...
- **Plan**: `.agents/projects/NPMDEP_npm-deprecation/planning/plan.md`
- **Architecture**: `.agents/projects/NPMDEP_npm-deprecation/planning/architecture.md` (sections "File Specifications" lines 291-355)
