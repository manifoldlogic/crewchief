...
**Planning References**:
- `.agents/projects/TESTDES_grep-impossible-task-design/planning/quality-strategy.md:62-90` - Ecological validity definition
- `.agents/projects/TESTDES_grep-impossible-task-design/planning/architecture.md:329-346` - Ecological validation architecture
- `.agents/projects/TESTDES_grep-impossible-task-design/planning/plan.md` - Phase 3.2 requirements
