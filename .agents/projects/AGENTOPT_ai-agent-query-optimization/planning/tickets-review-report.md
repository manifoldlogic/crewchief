...
**Review Scope**: All tickets in `.agents/projects/AGENTOPT_ai-agent-query-optimization/tickets/`
...
```
INCORRECT: .agents/work-in-progress/AGENTOPT-replan-analysis.md
CORRECT:   .agents/projects/AGENTOPT_ai-agent-query-optimization/replan-analysis.md

INCORRECT: .agents/work-in-progress/search-tasks-deep-thinking.md
CORRECT:   .agents/projects/AGENTOPT_ai-agent-query-optimization/search-tasks-analysis.md
```
...
**Issues Found**:
- ⚠️ References outdated path `.agents/work-in-progress/AGENTOPT-replan-analysis.md`
...
1. **Delete duplicate pre-pivot tickets**:
   ```bash
   cd .agents/projects/AGENTOPT_ai-agent-query-optimization/tickets/
...
2. **Fix documentation reference paths** in Phase 1 tickets:
   - Update `AGENTOPT-1001`: `.agents/work-in-progress/AGENTOPT-replan-analysis.md` → `../replan-analysis.md`
   - Update `AGENTOPT-1002`: Same path fix
   - Update `AGENTOPT-1003`: Same path fix
   - Update `AGENTOPT-1004`: `.agents/work-in-progress/search-tasks-deep-thinking.md` → `../search-tasks-analysis.md`
