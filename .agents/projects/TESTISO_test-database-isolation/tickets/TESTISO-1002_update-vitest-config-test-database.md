...
- Planning doc: `/workspace/.agents/projects/TESTISO_test-database-isolation/planning/plan.md` (Phase 2)
- Architecture: `/workspace/.agents/projects/TESTISO_test-database-isolation/planning/architecture.md` (Container vs Host Context section)
