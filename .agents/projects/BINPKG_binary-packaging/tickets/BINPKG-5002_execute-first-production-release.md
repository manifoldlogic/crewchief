...
Create file: `.agents/projects/BINPKG_binary-packaging/RELEASE_REPORT_vX.Y.Z.md`
...
- **CREATE**: `.agents/projects/BINPKG_binary-packaging/RELEASE_REPORT_vX.Y.Z.md` - production release report
- **MODIFY**: `.agents/projects/BINPKG_binary-packaging/README.md` - mark project as COMPLETE
