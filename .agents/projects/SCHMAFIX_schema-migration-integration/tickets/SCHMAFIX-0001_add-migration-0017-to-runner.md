...
**Planning Reference**: `.agents/projects/SCHMAFIX_schema-migration-integration/planning/tickets-review-report.md` (CRITICAL-2: Missing Migration 0017)
...
**References**:
- Original project: `.agents/projects/IDXSIZE_index-size-limits/` (likely archived)
...
- SCHMAFIX planning: `.agents/projects/SCHMAFIX_schema-migration-integration/planning/`
- Ticket review: `.agents/projects/SCHMAFIX_schema-migration-integration/planning/tickets-review-report.md`
