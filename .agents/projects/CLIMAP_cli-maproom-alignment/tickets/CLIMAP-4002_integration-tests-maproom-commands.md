...
- CLIMAP Planning: `/workspace/.agents/projects/CLIMAP_cli-maproom-alignment/planning/plan.md` (Phase 4, Task 4.2)
- Quality Strategy: `/workspace/.agents/projects/CLIMAP_cli-maproom-alignment/planning/quality-strategy.md` (Integration Test section)
- Related Tickets:
