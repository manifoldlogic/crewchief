...
## Planning References
- Architecture doc: `.agents/projects/CLIMAP_cli-maproom-alignment/planning/architecture.md` (Section 1: Command Structure Refactoring)
- Quality strategy: `.agents/projects/CLIMAP_cli-maproom-alignment/planning/quality-strategy.md` (Integration test requirements)
- Plan: `.agents/projects/CLIMAP_cli-maproom-alignment/planning/plan.md` (Phase 2, tasks 2.1-2.3)
