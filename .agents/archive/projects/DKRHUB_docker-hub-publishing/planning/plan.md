...
1. **`.agents/work-tickets/LOCAL-4006_optimize-docker-image-size.md`** (✅ COMPLETED)
...
2. **`.agents/work-tickets/LOCAL-4005_arm64-apple-silicon-testing.md`** (relates to multi-platform)
   - Defines ARM64/Apple Silicon testing requirements
   - **Action**: Use test cases from this ticket for multi-platform validation

3. **`.agents/work-tickets/LOCAL-3008_npm-publish-test-release.md`** (⚠️ INCOMPLETE)
   - Covers npm publishing workflow
   - **Action**: Complete this after Docker images are available

4. **`.agents/work-tickets/MCPSTART-6004_publish-npm-v1-1-9.md`** (⚠️ BLOCKED)
