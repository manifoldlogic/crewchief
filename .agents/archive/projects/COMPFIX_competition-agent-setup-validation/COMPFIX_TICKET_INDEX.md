...
- `.agents/projects/COMPFIX_competition-agent-setup-validation/validation-results/optimizer-*.log`
...
- `.agents/projects/COMPFIX_competition-agent-setup-validation/validation-results/error-scenario-*.log`
