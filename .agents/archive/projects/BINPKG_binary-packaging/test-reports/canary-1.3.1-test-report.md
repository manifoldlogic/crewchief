...
- **Project planning**: `/workspace/.agents/projects/BINPKG_binary-packaging/planning/plan.md`
- **Workflow architecture**: `/workspace/.agents/projects/BINPKG_binary-packaging/planning/architecture.md`
