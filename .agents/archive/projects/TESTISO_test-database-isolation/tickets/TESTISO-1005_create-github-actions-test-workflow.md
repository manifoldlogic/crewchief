...
- Project plan: `/workspace/.agents/projects/TESTISO_test-database-isolation/planning/plan.md` (Phase 4)
- Architecture: `/workspace/.agents/projects/TESTISO_test-database-isolation/planning/architecture.md` (CI/CD Architecture section)
