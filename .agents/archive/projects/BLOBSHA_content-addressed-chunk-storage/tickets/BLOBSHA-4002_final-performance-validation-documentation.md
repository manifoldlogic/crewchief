...
- **READ**: `.agents/projects/BLOBSHA_content-addressed-chunk-storage/planning/plan.md` (reference)
- **READ**: `.agents/projects/BLOBSHA_content-addressed-chunk-storage/planning/architecture.md` (reference)
