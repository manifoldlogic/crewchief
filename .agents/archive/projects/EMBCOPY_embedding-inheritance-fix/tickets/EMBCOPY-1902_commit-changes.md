...
Reference: `.agents/projects/EMBCOPY_embedding-inheritance-fix/planning/plan.md` (lines 127-153)
...
- [ ] Project archived to `.agents/archive/projects/` (ready for archival)
...
2. **Archive project:**
   ```bash
   mkdir -p .agents/archive/projects
   mv .agents/projects/EMBCOPY_embedding-inheritance-fix \
      .agents/archive/projects/
   ```
...
- Git commit only
- Project archive location: `.agents/archive/projects/EMBCOPY_embedding-inheritance-fix/`
