...
- **Analysis:** `.agents/projects/EMBCOPY_embedding-inheritance-fix/planning/analysis.md`
- **Architecture:** `.agents/projects/EMBCOPY_embedding-inheritance-fix/planning/architecture.md`
- **Quality Strategy:** `.agents/projects/EMBCOPY_embedding-inheritance-fix/planning/quality-strategy.md`
- **Security Review:** `.agents/projects/EMBCOPY_embedding-inheritance-fix/planning/security-review.md`
- **Plan:** `.agents/projects/EMBCOPY_embedding-inheritance-fix/planning/plan.md`
