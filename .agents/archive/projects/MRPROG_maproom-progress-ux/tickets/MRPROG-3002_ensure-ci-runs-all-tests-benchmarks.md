...
- **Plan**: `.agents/projects/MRPROG_maproom-progress-ux/planning/plan.md` (Phase 3, task 3)
- **Quality strategy**: `.agents/projects/MRPROG_maproom-progress-ux/planning/quality-strategy.md` (CI integration)
