...
This ticket implements Phase 2, Task 1 from `.agents/projects/MRPROG_maproom-progress-ux/planning/plan.md`.
...
## References
- **Architecture**: `.agents/projects/MRPROG_maproom-progress-ux/planning/architecture.md` (section "Changes to watch_worktree()")
- **Plan**: `.agents/projects/MRPROG_maproom-progress-ux/planning/plan.md` (Phase 2, Task 1)
