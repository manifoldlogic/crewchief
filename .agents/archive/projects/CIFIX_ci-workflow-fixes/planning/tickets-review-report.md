...
mv .agents/projects/CIFIX_ci-workflow-fixes/tickets/CIFIX-2001_update-release-workflow-pnpm-build.md \
   .agents/projects/CIFIX_ci-workflow-fixes/tickets/CIFIX-2005_update-release-workflow-pnpm-build.md
```
...
4. ✅ Archive CIFIX project to `.agents/archive/projects/`
