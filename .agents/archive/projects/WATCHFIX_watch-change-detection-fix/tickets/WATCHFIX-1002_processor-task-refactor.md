...
## Planning References
- **Analysis**: `/workspace/.agents/projects/WATCHFIX_watch-change-detection-fix/planning/analysis.md` (Root Cause Analysis section, lines 658-724 analysis)
- **Architecture**: `/workspace/.agents/projects/WATCHFIX_watch-change-detection-fix/planning/architecture.md` (processor_task Refactoring section with pseudocode)
- **Plan**: `/workspace/.agents/projects/WATCHFIX_watch-change-detection-fix/planning/plan.md` (Phase 2 deliverables, lines 59-95)
