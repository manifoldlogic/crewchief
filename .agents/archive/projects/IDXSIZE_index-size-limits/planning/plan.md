...
**References**:
- Project: `.agents/projects/IDXSIZE_index-size-limits/`
- Analysis: `.agents/projects/IDXSIZE_index-size-limits/planning/analysis.md`
```
...
**File**: `/workspace/.agents/projects/IDXSIZE_index-size-limits/README.md`
