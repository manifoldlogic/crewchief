...
This ticket implements Step 1.2 from `.agents/projects/IDXSIZE_index-size-limits/planning/plan.md`.
...
Follow the SQL structure defined in `.agents/projects/IDXSIZE_index-size-limits/planning/plan.md` Step 1.2 (lines 92-112). The rollback is provided for completeness but forward migration is strongly preferred.
...
## Planning References
- `.agents/projects/IDXSIZE_index-size-limits/planning/plan.md` - Step 1.2 (lines 89-118)
