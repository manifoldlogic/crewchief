...
- **Reference**: `/workspace/.agents/projects/DAEMIGR_daemon-client-migration/planning/architecture.md` (link from README)
- **Reference**: `/workspace/.agents/projects/DAEMIGR_daemon-client-migration/planning/quality-strategy.md` (performance characteristics)
