...
- **Project Review**: `.agents/projects/VSCDAEMN_vscode-daemon-migration/planning/project-review.md`
...
- **DAEMIGR Project**: `.agents/projects/DAEMIGR_daemon-client-migration/` (daemon-client package)
