...
`.agents/projects/CFGVER_config-version-management/pre-release-checklist.md`
...
- **Create**: `.agents/projects/CFGVER_config-version-management/pre-release-checklist.md` (optional documentation)
