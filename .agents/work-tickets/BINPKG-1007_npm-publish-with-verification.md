...
- `/workspace/.agents/projects/BINPKG_binary-packaging/planning/architecture.md` - Publish flow architecture
...
### Planning Documents
- **Project plan**: `.agents/projects/BINPKG_binary-packaging/planning/plan.md` (Phase 1, lines 63-79)
- **Architecture**: `.agents/projects/BINPKG_binary-packaging/planning/architecture.md` (lines 213-248)
